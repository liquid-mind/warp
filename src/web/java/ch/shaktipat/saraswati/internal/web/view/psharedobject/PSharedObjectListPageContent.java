...
public class PSharedObjectListPageContent extends ListPageContent
{

	public PSharedObjectListPageContent( Controller controller )
	{
		super( controller );
	}
	...
	{
		PSharedObjectListRowModel pRow = (PSharedObjectListRowModel)row;
