...
public class ConstPoolHelper
{
	...
	public static int getMethodRefInfo( ConstPool constPool, String className, String name, String type )
	{
		int cpIndex = -1;

		int classNameIndex = getClassInfo( constPool, className );
		int nameAndTypeIndex = getNameAndType( constPool, name, type );
